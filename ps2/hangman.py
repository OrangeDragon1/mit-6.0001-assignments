    ...
    * After each guess, you should display to the user the 
    ...
    while guesses > 0:
        ...
        if guess in secret_word:
            ...
            if guess in "aeiou":
                print("You guessed the wrong vowel, so you lose 2 guesses.")
                guesses -= 2
            else:
                guesses -= 1
        ...
        if is_word_guessed(secret_word, letters_guessed):
            ...
            print("Your total score for this game is:", (guesses + 1) * len(set(secret_word)))
            return
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while guesses > 0:
        ...
        print("You have", guesses, "guesses left.")
        print("Available letters:", get_available_letters(letters_guessed))
        guess = str.lower(input("Please guess a letter (Or enter '*' for hints): "))
        ...
        if guess == "*":
            ...
            guessed_word_length = ((get_guessed_word(secret_word, letters_guessed)).replace(" ", "")).replace("_", "")
            if len(guessed_word_length) > 0:
                print("Possible word matches are: \n", show_possible_matches(guessed_word))
            else:
                print("Please guess 1 character before calling for hints.")
            print("-------------")
            continue
